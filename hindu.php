...
<!-- header ends here  -->
  ...
  <div class="container padding-bottom-3x mb-1"  id="div13211" style="margin-top: 80px;">
  <div class="card mb-3">
    <div class="p-4 text-center text-white text-lg bg-dark rounded-top"><span>
    The Rig Veda is an ancient text written in Sanskrit is the oldest known book in the world</sapn>
  </div>
    </div>
    </div>
...
<?php
  ...
  // $new = strtolower($id);
$sql = "SELECT * FROM `product` WHERE cat='Hindu-Religion-Book' ORDER BY offer_price DESC LIMIT 60";
$result = mysqli_query($conn , $sql);
...
<form action="hindu.php" method="post" class="form-container">
