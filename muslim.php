...
/* login ends here  */      
  ...
  <div class="card mb-3">
    ...
    Islam means “to surrender.” Muslim means “one who peacefully surrenders to God.”</sapn>
  </div>
    </div>
    </div>
...
<?php
  ...
  // $new = strtolower($id);
$sql = "SELECT * FROM `product` WHERE cat='Islam-Religion-Book' ORDER BY offer_price DESC LIMIT 60";
