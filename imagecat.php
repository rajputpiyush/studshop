...
<div class="container padding-bottom-3x"  id="div132" style="margin-top: 50px; margin-bottom: -15px;">
    <div class="card mb-3">
      <div class="p-4 text-center text-white text-lg bg-dark rounded-top"><span>-- Best tranding Products -- </sapn>
    </div>
      </div>
      </div>
...
<?php
$sql = "SELECT * FROM `product` ORDER BY offer_price DESC LIMIT 6";
