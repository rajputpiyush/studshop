...
/* login ends here  */      
  ...
  Sikhism is a monotheistic religion, and the basic Sikh belief is represented in the phrase Ik Onkar meaning "One God."</sapn>
  </div>
    </div>
    </div>
...
<?php
  ...
  // $new = strtolower($id);
$sql = "SELECT * FROM `product` WHERE cat='Sikh-Religion-Book' ORDER BY offer_price DESC LIMIT 60";
