...
/* full login design ends here do not touch it  */
  ...
  <body>
      ...
      <div class="container padding-bottom-3x mb-1" id="div132" style="margin-top: 100px;">
    <div class="card mb-3">
      <div class="p-4 text-center text-white text-lg bg-dark rounded-top"><span>Thanks for purchasing! Go to your profile for check order status and download invoice </sapn>
    </div>
      </div>
      </div>
